...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        (0, _bookmarksViewJsDefault.default).render(_modelJs.state.bookmarks);
        // Change ID in URL
        window.history.pushState(null, "", `3${_modelJs.state.recipe.id}`);
        // window.history.back();
        // Close form window
        setTimeout(function() {
...
const init = function() {
    ...
    (0, _recipeViewJsDefault.default).addHandlerRander(controlRecipes);
...
const KEY = "3ebba09c-c828-4e11-813b-565b6c39faee";
...
},{"./helpers/bundle-url":"lgJ39"}],"hJO4d":[function(require,module,exports) {
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        ...
        <div class="pagination__btn--prev">
          <span>${curPage}</span>
        </div>
